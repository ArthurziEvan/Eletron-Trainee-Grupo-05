...
O custo total estimado dos componentes apresentados na Tabela de Materiais é de:

\begin{center}
\textbf{R\$ 94,15}
\end{center}

Esse valor considera a quantidade de cada item utilizada no projeto, incluindo componentes discretos como resistores e LEDs.